                    ...
                    <div className="product-box">
                      <div className="img-wrapper">
                        <div className="front">
                          <a href="#">
                            <Media
                              ...
                              alt=""
                              onClick={() =>
                                clickProductDetail(data.products.items[2])
                              }
                            />
                          </a>
                        </div>
                        <div className={cartClass}>
                          <button
                            onClick={() =>
                              cartContext.addToCart(data.products.items[2], qty)
                            }
                            title="Add to cart"
                          >
                            <i className="fa fa-shopping-cart"></i>
                          ...
                          <a
                            ...
                            title="Add to Wishlist"
                            onClick={() =>
                              wishlistContext.addToWish(data.products.items[2])
                            }
                          >
                          ...
                          <a
                            ...
                            title="Quick View"
                            onClick={() =>
                              singleProduct(data.products.items[2])
                            }
                          >
                      ...
                      <div className="details-product">
                        ...
                        >
                          <h6>{data.products.items[2].title}</h6>
                        </a>
                        <h4>${data.products.items[2].price}</h4>
                      </div>
                    </div>
                  </Col>
                </Row>
                ...
                <div className="product-box">
                  <div className="img-wrapper">
                    <div className="front">
                      <a href={null}>
                        <Media
                          ...
                          alt=""
                          onClick={() =>
                            clickProductDetail(data.products.items[3])
                          }
                        />
                      </a>
                    </div>
                    <div className={cartClass}>
                      <button
                        onClick={() =>
                          cartContext.addToCart(data.products.items[3], qty)
                        }
                        title="Add to cart"
                      >
                        <i className="fa fa-shopping-cart"></i>
                      ...
                      <a
                        ...
                        title="Add to Wishlist"
                        onClick={() =>
                          wishlistContext.addToWish(data.products.items[3])
                        }
                      >
                        <i className="fa fa-heart" aria-hidden="true"></i>
                      </a>
                      ...
                      <a
                        ...
                        title="Compare"
                        onClick={() =>
                          compareContext.addToCompare(data.products.items[3])
                        }
                      >
                        <i className="fa fa-refresh" aria-hidden="true"></i>
                      </a>
                  ...
                  <div className="details-product">
                    ...
                    >
                      <h6>{data.products.items[3].title}</h6>
                    </a>
                    <h4>${data.products.items[3].price}</h4>
                  </div>
                </div>
              </Col>
            </Row>
                ...
                <div className="product-box">
                  <div className="img-wrapper">
                    <div className="front">
                      <a href={null}>
                        <Media
                          ...
                          alt=""
                          onClick={() =>
                            clickProductDetail(data.products.items[4])
                          }
                        />
                      </a>
                    </div>
                    <div className={cartClass}>
                      <button
                        onClick={() =>
                          cartContext.addToCart(data.products.items[4], qty)
                        }
                        title="Add to cart"
                      >
                        <i className="fa fa-shopping-cart"></i>
                      ...
                      <a
                        ...
                        title="Add to Wishlist"
                        onClick={() =>
                          wishlistContext.addToWish(data.products.items[4])
                        }
                      >
                        <i className="fa fa-heart" aria-hidden="true"></i>
                      </a>
                      ...
                      <a
                        ...
                        title="Compare"
                        onClick={() =>
                          compareContext.addToCompare(data.products.items[4])
                        }
                      >
                        <i className="fa fa-refresh" aria-hidden="true"></i>
                      </a>
                  ...
                  <div className="details-product">
                    ...
                    >
                      <h6>{data.products.items[4].title}</h6>
                    </a>
                    <h4>${data.products.items[4].price}</h4>
                  </div>
                </div>
              </Col>
              <Col md="6" className="col-12 p-0">
                <Row className="m-0">
                  {data &&
                    data.products.items.slice(5, 9).map((product, i) => (
                      <Col sm="6" className="col-12 p-0" key={i}>
                        <div className="product-box">
                          <div className="img-wrapper">
                            <div className="front">
                  ...
                  <Row>
                    ...
                    <Col lg="6" className="rtl-text">
                      <div className="product-right">
                        ...
                        <h3>
                          {currency.symbol}
                          {(productPopUp.price * currency.value).toFixed(2)}
                        </h3>
                        {productPopUp.variants ? (
                          <ul className="color-variant">
                            {uniqueTags ? (
                              <ul className="color-variant">
                                {productPopUp.type === "jewellery" ||
                                productPopUp.type === "nursery" ||
                                productPopUp.type === "beauty" ||
                                productPopUp.type === "electronics" ||
                                productPopUp.type === "goggles" ||
                                productPopUp.type === "watch" ||
                                productPopUp.type === "pets" ? (
                                  ""
                                ) : (
                                  <>
                                    {uniqueTags ? (
                        ...
                        <div className="product-buttons">
                          <button
                            ...
                            onClick={() =>
                              cartContext.addToCart(productPopUp, qty)
                            }
                          >
                            add to cart
                          </button>
